...
import com.tzc.biz.common.exception.NetworkGrabException;

/**
 * @描述：
 * @作者：limeng
 * @创建时间：Oct 12, 20124:24:50 PM
 */
...
public class NetworkGrabService {
	...
	public <T> T grabAsStream(String sourceUrl,
		...
		try {
			...
			throw new NetworkGrabException(e);
		}
		...
		try {
			...
			if (statusCode != HttpStatus.SC_OK) {
				...
				throw new NetworkGrabException("Method failed: "
