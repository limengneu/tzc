...
import com.tzc.common.web.exception.SchoolWebException;
 ...
 */
public class SchoolEscapeHtmlReference implements
ReferenceInsertionEventHandler, RuntimeServicesAware{
	...
	private String escape(String str) {
		...
		try {
			...
			throw new SchoolWebException(e);
		}
	}
